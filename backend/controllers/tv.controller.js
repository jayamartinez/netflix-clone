...
export async function getTrendingTv(req, res) {
    try {
        const data = await fetchTMDB("https://api.themoviedb.org/3/tv/popular?language=en-US&page=1")
...
export async function getSimilarTvs(req, res) {
    const { id } = req.params
    try {
        const data = await fetchTMDB(`https://api.themoviedb.org/3/tv/${id}/similar?language=en-US`)
